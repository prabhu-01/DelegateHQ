    ...
    <footer className="relative px-6 pt-16 pb-10" style={{ borderTop: "1px solid rgba(255,255,255,0.06)" }}>
      <div className="w-full max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
          ...
          <div className="md:col-span-4 flex flex-col gap-5">
            ...
            <p className="text-sm text-slate-600 max-w-xs" style={{ lineHeight: "1.75" }}>
              AI operations agency deploying vertically specialized agent teams for bootstrapped SaaS founders. Everything, handled.
            </p>
          ...
          <div className="md:col-span-5 flex flex-col gap-5">
            ...
            <div className="grid grid-cols-2 gap-y-2.5 gap-x-4">
              <button
                ...
                className="flex items-center gap-2 text-sm text-left cursor-pointer transition-colors duration-150 group"
                style={{ color: "#475569", background: "transparent", border: "none", padding: 0 }}
                onMouseEnter={(e) => (e.currentTarget.style.color = "#f1f5f9")}
                onMouseLeave={(e) => (e.currentTarget.style.color = "#475569")}
              >
                SaaS & Tech
                <span className="font-mono text-xs px-1.5 py-0.5 rounded" style={{ background: "rgba(16,185,129,0.1)", color: "#34d399", fontSize: "10px" }}>Active</span>
              </button>
              {["Ecommerce", "Real Estate", "Legal", "Healthcare", "Finance", "HR & Recruiting", "Education", "Logistics", "Hospitality", "Insurance"].map((d) => (
                <span key={d} className="text-sm" style={{ color: "#1e293b" }}>{d}</span>
              ))}
            </div>
          </div>
        ...
        >
          ...
          <div className="flex items-center gap-2.5">
            <span className="font-mono text-xs" style={{ color: "#1e293b" }}>SaaS & Tech Division — Now Open</span>
